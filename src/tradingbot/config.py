...
class RiskLimits(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="TB_RISK_")
...
class ExitSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_EXIT_")
...
class KalshiCreds(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="TB_KALSHI_")
...
class PolymarketCreds(BaseSettings):
    model_config = SettingsConfigDict(env_prefix="TB_POLY_")
...
class AnthropicCreds(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_ANTHROPIC_")
...
class TelegramCreds(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_TELEGRAM_")
...
class GoalSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_GOAL_")
...
class AutopilotSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_AUTOPILOT_")
...
class MarketMakerSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_MM_")
...
class StreamingSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_STREAMING_")
...
class ApiSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(env_prefix="TB_API_")
